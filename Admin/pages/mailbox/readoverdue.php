...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM riwayat WHERE id = " . $id;
    $result = $mysqli->query($sql);
    if ($result->num_rows > 0) {
        $riwayat = $result->fetch_array();
    } else {
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="<?= $url ?>" class="btn btn-primary btn-block mb-3">Back</a>
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <ul class="nav nav-pills flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="overdue.php" class="nav-link" style="color: dodgerblue;">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body p-0">
                                    <div class="mailbox-read-message">
                                        <p>
                                        <h3>
                                            <td class="mailbox-subject"><b><?= $riwayat['nama_event'] ?> | <b><?= $riwayat['tema'] ?>
                                        </h3>
                                        <h5>
                                            <td class="mailbox-subject">From: <?= $riwayat['nama_instansi'] ?>
                                        </h5>
                                        </p>
                                        <table>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><?= $riwayat['rentang_usia'] ?> Tahun</td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Jumlah Audiens</td>
                                                <td>:</td>
                                                <td><?= $riwayat['jumlah_audiens'] ?> Orang</td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Tanggal Pelaksanaan</td>
                                                <td>:</td>
                                                <td><?= $riwayat['start_event'] ?> - <?= $riwayat['end_event'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="../../pdf/<?= $riwayat['file'] ?>" target="_blank">Lihat Surat Undangan</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
