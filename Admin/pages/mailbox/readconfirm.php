...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM terkonfirmasi WHERE id = " . $id;
    $result = $mysqli->query($sql);
    if ($result->num_rows > 0) {
        $terkonfirmasi = $result->fetch_array();
    } else {
...
<head>
    ...
    <title>Read Confirmed Mail</title>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <ul class="nav nav-pills flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="terkonfirmasi.php" class="nav-link" style="color: dodgerblue;">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body p-0">
                                    <div class="mailbox-read-message">
                                        <p>
                                        <h3>
                                            <td class="mailbox-subject"><b><?= $terkonfirmasi['title'] ?> | <b><?= $terkonfirmasi['tema'] ?>
                                        </h3>
                                        <h5>
                                            <td class="mailbox-subject">From: <?= $terkonfirmasi['nama_instansi'] ?>
                                        </h5>
                                        </p>
                                        <table>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><?= $terkonfirmasi['nama_pj'] ?></td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Email</td>
                                                <td>:</td>
                                                <td><?= $terkonfirmasi['email'] ?></td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">No. Telepon</td>
                                                <td>:</td>
                                                <td><?= $terkonfirmasi['no_telepon'] ?></td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Rentang Usia</td>
                                                <td>:</td>
                                                <td><?= $terkonfirmasi['rentang_usia'] ?> Tahun</td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Jumlah Audiens</td>
                                                <td>:</td>
                                                <td><?= $terkonfirmasi['jumlah_audiens'] ?> Orang</td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Tanggal Pelaksanaan</td>
                                                <td>:</td>
                                                <td><?= $terkonfirmasi['start_event'] ?> - <?= $terkonfirmasi['end_event'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="../../pdf/<?= $terkonfirmasi['file'] ?>" target="_blank">Lihat Surat Undangan</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
