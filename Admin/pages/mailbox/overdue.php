...
// mengambil data undangan
$data_riwayat = mysqli_query($mysqli, $sql);
// menghitung data undangan
...
if (isset($_POST['btn_delete'])) {
    if (isset($_POST['selected'])) {
        foreach ($_POST['selected'] as $selectedid) {
            ...
            $deleteData = "DELETE from form WHERE id=" . $selectedid;
                                ...
                                <div class="card-tools">
                                    <form action="overdue.php" method="get">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="search" value="<?= @$search ?>" placeholder="Cari Riwayat">
                                    ...
                                    <div class="table-responsive mailbox-messages">
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $jumlah_data = mysqli_num_rows($data_riwayat);
                                                ...
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <a href="deleteoverdue.php?id=<?php echo $form['id']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" class="link">
                                                                <i class="far fa-trash-alt"></i>
                                                            </a>
                                                        </td>
                                                        <td class="mailbox-subject"><b><?= $form['nama_instansi'] ?></b> - <?= $form['nama_pj'] ?>
                                                        <td class="mailbox-name">
                                                            <a href="readoverdue.php?id=<?= $form['id']; ?>">
                                                                <?= $form['nama_event'] ?>
                                                            </a>
                                                        </td>
