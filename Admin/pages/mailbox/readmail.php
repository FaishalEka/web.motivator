...
<head>
    ...
    <title>Read Invitation Mail</title>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <ul class="nav nav-pills flex-column">
                                        <li class="nav-item">
                                            <a href="mailbox.php" class="nav-link" style="color: dodgerblue;">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="mailbox-read-message">
                                        <p>
                                        <h3>
                                            <td class="mailbox-subject"><b><?= $form['nama_event'] ?> | <b><?= $form['tema'] ?>
                                        </h3>
                                        <h5>
                                            <td class="mailbox-subject">From: <?= $form['nama_instansi'] ?>
                                        </h5>
                                        </p>
                                        <table>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><?= $form['rentang_usia'] ?> Tahun</td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Jumlah Audiens</td>
                                                <td>:</td>
                                                <td><?= $form['jumlah_audiens'] ?> Orang</td>
                                            </tr>
                                            <tr>
                                                <td class="mailbox-subject">Tanggal Pelaksanaan</td>
                                                <td>:</td>
                                                <td><?= $form['start_event'] ?> - <?= $form['end_event'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                <a href="../../pdf/<?= $form['file'] ?>" target="_blank">Lihat Surat Undangan</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
